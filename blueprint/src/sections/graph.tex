...
\begin{lemma}\label{lemma:collatz_graph_adj_iff}\lean{CollatzMapBasics.collatz_graph_adj_iff}\uses{def:collatz_graph}\leanok
...
\begin{lemma}\label{lemma:T_iter_reachable}\lean{CollatzMapBasics.T_iter_reachable}\uses{def:collatz_graph}\leanok
...
\begin{lemma}\label{lemma:confluence_step}\lean{CollatzMapBasics.confluence_step}\uses{def:collatz_graph}\leanok
...
\begin{lemma}\label{lemma:confluence_of_reachable}\lean{CollatzMapBasics.confluence_of_reachable}\uses{lemma:confluence_step}\leanok
...
\begin{theorem}\label{theorem:collatz_graph_weakly_connected_iff_collatz}\lean{CollatzMapBasics.collatz_graph_weakly_connected_iff_collatz}\uses{lemma:confluence_of_reachable,lemma:T_iter_reachable,lemma:collatz_iter_to_T_iter,lemma:T_iter_implies_collatz_iter}\leanok
