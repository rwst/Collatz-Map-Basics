...
\begin{lemma}\label{lemma:E_vec_le_one}\lean{CollatzMapBasics.E_vec_le_one}\uses{lemma:X_eq_mod}\leanok
...
\begin{lemma}\label{lemma:num_odd_steps_eq_of_E_vec_eq}\lean{CollatzMapBasics.num_odd_steps_eq_of_E_vec_eq}\uses{lemma:num_odd_steps_eq_E_vec_sum}\leanok
