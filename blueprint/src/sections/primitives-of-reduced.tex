\begin{lemma}\label{lemma:R_4n_add_1}\lean{CollatzMapBasics.R_4n_add_1}\leanok
...
\end{proof}
\begin{lemma}\label{lemma:R_iter_4n_add_1}\lean{CollatzMapBasics.R_iter_4n_add_1}\uses{lemma:R_4n_add_1}\leanok
...
\begin{lemma}\label{lemma:rcs_ge}\lean{CollatzMapBasics.rcs_ge}\leanok
...
\begin{definition}\label{def:IsPrimitive4x1}\lean{CollatzMapBasics.IsPrimitive4x1}\leanok
...
\begin{lemma}\label{lemma:is_primitive_iff_mod_8_ne_5}\lean{CollatzMapBasics.is_primitive_iff_mod_8_ne_5}\uses{lemma:R_iter_4n_add_1}\leanok
...
\begin{lemma}\label{lemma:primitive_ancestor}\lean{CollatzMapBasics.primitive_ancestor}\uses{lemma:R_4n_add_1}\leanok
...
\begin{lemma}\label{lemma:odd_node_generates_primitive}\lean{CollatzMapBasics.odd_node_generates_primitive}\uses{lemma:exists_R_with_m_not_div3,lemma:primitive_ancestor,lemma:is_primitive_iff_mod_8_ne_5}\leanok
...
\begin{definition}\label{def:reduce4x1}\lean{CollatzMapBasics.reduce4x1}\leanok
...
\begin{lemma}\label{lemma:rcs_reduce4x1}\lean{CollatzMapBasics.rcs_reduce4x1}\uses{lemma:R_4n_add_1}\leanok
...
\begin{lemma}\label{lemma:primitives_from_distinct_generators_ne}\lean{CollatzMapBasics.primitives_from_distinct_generators_ne}\uses{lemma:rcs_reduce4x1}\leanok
...
\begin{lemma}\label{lemma:exists_large_not_div3_from_seed}\lean{CollatzMapBasics.exists_large_not_div3_from_seed}\uses{lemma:R_iter_4n_add_1}\leanok
...
\begin{lemma}\label{lemma:infinite_primitives}\lean{CollatzMapBasics.infinite_primitives}\uses{lemma:exists_large_not_div3_from_seed,lemma:odd_node_generates_primitive,lemma:rcs_ge}\leanok
