...
\end{proof}
\begin{lemma}\label{lemma:R_iter_4n_add_1}\lean{CollatzMapBasics.R_iter_4n_add_1}\leanok
...
\begin{lemma}\label{lemma:is_primitive_iff_mod_8_ne_5}\lean{CollatzMapBasics.is_primitive_iff_mod_8_ne_5}\leanok
...
\begin{lemma}\label{lemma:primitive_ancestor}\lean{CollatzMapBasics.primitive_ancestor}\leanok
...
\begin{lemma}\label{lemma:odd_node_generates_primitive}\lean{CollatzMapBasics.odd_node_generates_primitive}\leanok
...
\begin{lemma}\label{lemma:rcs_reduce4x1}\lean{CollatzMapBasics.rcs_reduce4x1}\leanok
...
\begin{lemma}\label{lemma:primitives_from_distinct_generators_ne}\lean{CollatzMapBasics.primitives_from_distinct_generators_ne}\leanok
...
\begin{lemma}\label{lemma:exists_large_not_div3_from_seed}\lean{CollatzMapBasics.exists_large_not_div3_from_seed}\leanok
...
\begin{lemma}\label{lemma:infinite_primitives}\lean{CollatzMapBasics.infinite_primitives}\leanok
