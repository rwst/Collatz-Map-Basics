...
\begin{lemma}\label{lemma:infinite_rat_approx_from_below}\lean{CollatzMapBasics.infinite_rat_approx_from_below}\uses{lemma:irrational_xi}\leanok
...
\begin{theorem}\label{theorem:exists_infinite_pairs_approx}\lean{CollatzMapBasics.exists_infinite_pairs_approx}\uses{lemma:infinite_rat_approx_from_below,lemma:inequality_equiv}\leanok
