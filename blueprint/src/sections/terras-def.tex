...
equivalent form, 1977)\cite{everett77}. It is also called the {\bf Syracuse map}.
...
\begin{lemma}\label{lemma:T_iter_pos}\lean{CollatzMapBasics.T_iter_pos}\uses{lemma:T_pos}\leanok
...
\begin{lemma}\label{lemma:T_congr}\lean{CollatzMapBasics.T_congr}\uses{lemma:parity_of_mod_pow_succ,lemma:X_congr,lemma:int_dvd_sub_of_mod_eq,lemma:nat_mod_eq_of_int_dvd_sub}\leanok
