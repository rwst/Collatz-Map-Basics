...
\begin{lemma}\label{lemma:reduced_collatz_step_iff_mod4}\lean{CollatzMapBasics.reduced_collatz_step_iff_mod4}\uses{lemma:ordCompl_two_pow_mul,lemma:ordCompl_two_mul_pow}\leanok
...
\begin{lemma}\label{lemma:reduced_collatz_step_implies_collatz_iter}\lean{CollatzMapBasics.reduced_collatz_step_implies_collatz_iter}\uses{lemma:collatz_iter_two_pow_mul}\leanok
