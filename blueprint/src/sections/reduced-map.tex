...
\begin{lemma}\label{lemma:reduced_collatz_step_iff_mod4}\lean{reduced_collatz_step_iff_mod4}\leanok
...
\begin{lemma}\label{lemma:reduced_collatz_step_implies_collatz_iter}\lean{reduced_collatz_step_implies_collatz_iter}\leanok
...
\begin{lemma}\label{lemma:reduced_collatz_iter_implies_collatz_iter}\lean{reduced_collatz_iter_implies_collatz_iter}\leanok
...
\begin{definition}\label{def:count_odds}\lean{count_odds}\leanok
...
\begin{lemma}\label{lemma:ordCompl_collatz_iter}\lean{ordCompl_collatz_iter}\leanok
...
\begin{lemma}\label{lemma:collatz_cycle_iff_reduced_collatz_cycle}\lean{collatz_cycle_iff_reduced_collatz_cycle}\leanok
...
\begin{lemma}\label{lemma:collatz_bounded_iff_reduced_collatz_bounded}\lean{collatz_bounded_iff_reduced_collatz_bounded}\leanok
