...
\end{definition}
This map seems to have been introduced by Crandall\cite{crandall78}. One of its advantages is
that multiplications by 3 are constant for each step, regardless if $n$ is even or odd.

\begin{definition}\label{def:R_iter}\lean{CollatzMapBasics.R_iter}\uses{def:reduced_collatz_step}\leanok
...
\begin{lemma}\label{lemma:R_zero}\lean{CollatzMapBasics.R_zero}\uses{def:reduced_collatz_step}\leanok
$R(0) = 1$.
\end{lemma}
\begin{proof}\leanok
...
\begin{lemma}\label{lemma:R_one}\lean{CollatzMapBasics.R_one}\uses{def:reduced_collatz_step}\leanok
$R(1) = 1$.
\end{lemma}
\begin{proof}\leanok
...
\begin{lemma}\label{lemma:reduced_collatz_step_pos}\lean{CollatzMapBasics.reduced_collatz_step_pos}\uses{def:reduced_collatz_step}\leanok
...
\begin{lemma}\label{lemma:reduced_collatz_step_odd}\lean{CollatzMapBasics.reduced_collatz_step_odd}\uses{def:reduced_collatz_step}\leanok
...
\begin{lemma}\label{lemma:not_exists_R_with_m_div3}\lean{CollatzMapBasics.not_exists_R_with_m_div3}\uses{def:reduced_collatz_step}\leanok
...
\begin{lemma}\label{lemma:exists_R_with_m_not_div3}\lean{CollatzMapBasics.exists_R_with_m_not_div3}\uses{lemma:ordCompl_two_mul_pow}\leanok
...
\begin{lemma}\label{lemma:reduced_collatz_step_iff_mod4}\lean{CollatzMapBasics.reduced_collatz_step_iff_mod4}\uses{lemma:ordCompl_two_pow_mul,lemma:ordCompl_two_mul_pow,def:reduced_collatz_step}\leanok
...
\begin{lemma}\label{lemma:reduced_collatz_step_implies_collatz_iter}\lean{CollatzMapBasics.reduced_collatz_step_implies_collatz_iter}\uses{lemma:collatz_iter_two_pow_mul}\uses{def:reduced_collatz_step,def:collatz_iter}\leanok
...
\begin{lemma}\label{lemma:reduced_collatz_iter_implies_collatz_iter}\lean{CollatzMapBasics.reduced_collatz_iter_implies_collatz_iter}\uses{lemma:reduced_collatz_step_implies_collatz_iter}\leanok
...
\begin{lemma}\label{lemma:ordCompl_collatz_iter}\lean{CollatzMapBasics.ordCompl_collatz_iter}\uses{lemma:ordCompl_two_div_two}\leanok
...
\begin{lemma}\label{lemma:collatz_cycle_iff_reduced_collatz_cycle}\lean{CollatzMapBasics.collatz_cycle_iff_reduced_collatz_cycle}\uses{lemma:ordCompl_collatz_iter,lemma:reduced_collatz_iter_implies_collatz_iter}\leanok
...
\begin{lemma}\label{lemma:collatz_bounded_iff_reduced_collatz_bounded}\lean{CollatzMapBasics.collatz_bounded_iff_reduced_collatz_bounded}\uses{lemma:reduced_collatz_iter_implies_collatz_iter,lemma:ordCompl_collatz_iter}\leanok
